 ...
 */
public class BalanceDrivetrainDistance extends CommandBase {
  ...
  public BalanceDrivetrainDistance(Drive subsystem, double distance) {
  ...
  public void execute() {
    ...
    complete = driveTrain.specificDriveCharge(driveDist);
  }
